...
- [x] ~~**Add ARIA labels to emoji buttons**~~ ([#15](https://github.com/MattCordell/Stoker/issues/15)) ✅ **COMPLETED**
...
- [x] ~~**Add modal accessibility attributes**~~ ([#16](https://github.com/MattCordell/Stoker/issues/16)) ✅ **COMPLETED**
